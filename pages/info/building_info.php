    ...
    <body>
        ...
        <div id="main_container">
            ...
            <div id="logged_in_container">
                <?php if($logged_in) {
                    echo ("<form id='edit_button' action='/pages/info/edit/edit_building.php'><input type='hidden' value='" + $building_id +  "' name='id'><input type='submit' value='Edit' method='POST'></form>");
                } ?>
            </div>
        </div>
    </body>
