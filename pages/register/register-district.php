...
<html>
    ...
    <body>
        ...
        <form action="/pages/register/register-district_submit.php" method="POST">
            ...
            <p>Enter the co-ordinates below, starting from the first corner of the district, in the order the borders connect. y, in this case, corresponds to the in-game z axis. A minimum of 3 points must be entered.</p>
